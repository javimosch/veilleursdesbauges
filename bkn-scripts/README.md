...
| `signalement-create.js` | `signalement-create` | Citizen report form, stores to `veilleurs/signalements` |
| `signalements-digest.js` | `signalements-digest` | Hourly cron, publishes signalements to hart |
...
None for VDB yet (veilleurs-attachments to be added).
